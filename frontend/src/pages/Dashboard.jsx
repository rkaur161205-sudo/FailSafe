      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="rounded-2xl p-6" style={{ background: "#2a2a3c", border: "1px solid #3a3a4c" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <img src="http://localhost:8000/ml/plots/feature_importance" alt="Feature importance" className="w-full rounded-xl" />
            <img src="http://localhost:8000/ml/plots/risk_distribution"  alt="Risk distribution"  className="w-full rounded-xl" />
          </div>
        </div>
